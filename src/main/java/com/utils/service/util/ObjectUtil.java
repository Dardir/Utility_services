...
public class ObjectUtil {
    ...
    public static String getServiceName(Exchange exchange) {
        return (String) exchange.getProperty(ConstantsEnum.ServiceName.getConstantValue());
    }

    public static void setServiceName(Exchange exchange, String serviceName) {
        exchange.setProperty(ConstantsEnum.ServiceName.getConstantValue(), serviceName);
    }
    ...
    public static <T> T getOriginalRequest(Exchange exchange) {
        return (T) exchange.getProperty(ConstantsEnum.OriginalMessage.getConstantValue());
    }

    public static <T> void setOriginalRequest(Exchange exchange, T originalMessage) {
        exchange.setProperty(ConstantsEnum.OriginalMessage.getConstantValue(), originalMessage);
    }
